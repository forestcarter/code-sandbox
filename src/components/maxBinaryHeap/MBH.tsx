  ...
  render() {
    return (
      <div className="pageContainer">
        <h6 id="heapSectionHeader" className="sectionHeader">
          Max Binary Heap
        </h6>
        ...
        <div className="addNumberContainer">
          ...
          />
          <Button
            disabled={!this.state.isValid || this.state.mbh.array.length > 17}
            id="heapAddButton"
          ...
          <Button
            disabled={this.state.mbh.array.length === 0}
            id="heapRemoveButton"
        ...
        <div className="descriptionContainer">
          <p className="description">
            This page allow items to be added and removed from a Max Binary
            Heap.{" "}
          </p>
        </div>
      </div>
